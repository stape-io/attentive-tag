...
[
  {
    ...
    "help": "You can find more info \u003ca href\u003d\"https://docs.attentivemobile.com/pages/authentication/\" target\u003d\"_blank\"\u003eby this link\u003c/a\u003e.",
    "valueValidators": [
      {
        "type": "NON_EMPTY"
      }
  ...
  },
  {
    ...
    "simpleValueType": true,
    "alwaysInSummary": false,
    "help": "Phone of the user who triggered this event"
  },
  {
    "type": "RADIO",
    "name": "eventType",
        ...
        },
        {
          ...
          "value": {
            ...
            "listItem": [
              {
                "type": 1,
                "string": "https://api.attentivemobile.com/*"
              }
            ]
          }
        }
...
Created on 02/02/2022, 22:13:33
